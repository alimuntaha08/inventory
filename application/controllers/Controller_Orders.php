			        ...
			        <table class="table table-striped table-bordered">
			          ...
			          foreach ($orders_items as $k => $v) {
			          	...
			          	$html .= '<tr>
				            ...
				            <td>'.$this->company_currency().number_format($v['rate'],2,',','.').'</td>
				            <td>'.$v['qty'].'</td>
				            <td>'.$this->company_currency().number_format($v['amount'],2,',','.').'</td>
			          	</tr>';
			          }
			        ...
			        <div class="table-responsive">
			          <table class="table table-striped">
			            <tr>
			              ...
			              <td>'.$this->company_currency().number_format($order_data['gross_amount'],2,',','.').'</td>
			            </tr>';

			            if($order_data['service_charge'] > 0) {
			            	$html .= '<tr>
				              <th>Service Charge ('.$order_data['service_charge_rate'].'%)</th>
				              <td>'.$this->company_currency().$order_data['service_charge'].'</td>
				            </tr>';
			            }
			            ...
			            if($order_data['vat_charge'] > 0) {
			            	$html .= '<tr>
				              ...
				              <td>'.$this->company_currency().number_format($order_data['vat_charge'],2,',','.').'</td>
				            </tr>';
			            }
			            //force discount to 0;
			            $order_data['discount']>0 ? $discount=$order_data['discount'] : $discount=0;
			            $html .=' <tr>
			              <th>Discount:</th>
			              <td>'.$this->company_currency().number_format($discount,2,',','.').'</td>
			            </tr>
			            <tr>
			              <th>Net Amount:</th>
			              <td>'.$this->company_currency().number_format($order_data['net_amount'],2,',','.').'</td>
			            </tr>
			            <tr>
			              <th>Bill Status:</th>
			              <td>'.$paid_status.'</td>

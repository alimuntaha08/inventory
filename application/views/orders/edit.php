              ...
              <div class="box-body">
                ...
                <div class="col-md-7 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <textarea type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Enter Client Address" value="" autocomplete="off"><?php echo $order_data['order']['customer_address'] ?></textarea> 
                    </div>
                  </div>
